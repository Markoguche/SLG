...
const L='#B8FF00';
const bgs={about:'#0c1a10',services:'#0c1a10',portfolio:'#060F09',organizations:'#0A2E1A',team:'#0c1a10',contact:'#0c1a10'};
const shapes={
    ...
    <section ref={ref} style={{background:bgs[pageKey]||'#0c1a10',paddingTop:'clamp(130px,15vw,190px)',paddingBottom:'clamp(56px,7vw,90px)',position:'relative',overflow:'hidden',borderBottom:'1px solid rgba(255,255,255,0.05)'}}>
      ...
      <div className="container" style={{position:'relative',zIndex:1}}>
        ...
        <h1 style={{maxWidth:'860px'}}>
          ...
          {titleEm&&<span className="split-line"><em className="ph-l2" style={{display:'block',color:'#B8FF00',fontStyle:'italic'}}>{titleEm}</em></span>}
        </h1>
