...
export default function RobotFigure() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.fromTo('#robot-body-group', { opacity: 0, y: 40, scale: 0.92 }, { opacity: 1, y: 0, scale: 1, duration: 1.2, ease: 'power4.out', delay: 0.8 });
      gsap.fromTo('#robot-head', { opacity: 0, y: -30 }, { opacity: 1, y: 0, duration: 0.9, ease: 'back.out(1.6)', delay: 1.0 });
      gsap.fromTo('#robot-arm-left', { opacity: 0, x: -24, rotate: -15, transformOrigin: '90px 160px' }, { opacity: 1, x: 0, rotate: 0, duration: 0.9, ease: 'back.out(1.4)', delay: 1.1 });
      gsap.fromTo('#robot-arm-right', { opacity: 0, x: 24, rotate: 15, transformOrigin: '210px 160px' }, { opacity: 1, x: 0, rotate: 0, duration: 0.9, ease: 'back.out(1.4)', delay: 1.15 });
      gsap.fromTo('#robot-legs', { opacity: 0, y: 20 }, { opacity: 1, y: 0, duration: 0.8, ease: 'power3.out', delay: 1.2 });
      gsap.fromTo('.data-line', { opacity: 0, scaleX: 0 }, { opacity: 1, scaleX: 1, stagger: 0.08, duration: 0.6, ease: 'power3.out', delay: 1.4, transformOrigin: 'left' });
      gsap.fromTo('.data-dot', { opacity: 0, scale: 0 }, { opacity: 1, scale: 1, stagger: 0.05, duration: 0.4, ease: 'back.out(2)', delay: 1.6 });
      gsap.fromTo('.orbit-ring', { opacity: 0, scale: 0.4 }, { opacity: 1, scale: 1, stagger: 0.1, duration: 0.8, ease: 'back.out(1.4)', delay: 1.3 });
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      <svg ref={svgRef} viewBox="0 0 300 520" xmlns="http://www.w3.org/2000/svg" className="w-full h-full" style={{ overflow: 'visible' }}>
        <defs>
          <filter id="glow-lime" x="-50%" y="-50%" width="200%" height="200%"><feGaussianBlur stdDeviation="4" result="blur" /><feMerge><feMergeNode in="blur" /><feMergeNode in="SourceGraphic" /></feMerge></filter>
          <filter id="glow-strong" x="-80%" y="-80%" width="260%" height="260%"><feGaussianBlur stdDeviation="9" result="blur" /><feMerge><feMergeNode in="blur" /><feMergeNode in="SourceGraphic" /></feMerge></filter>
          <filter id="glow-soft" x="-30%" y="-30%" width="160%" height="160%"><feGaussianBlur stdDeviation="3" result="blur" /><feMerge><feMergeNode in="blur" /><feMergeNode in="SourceGraphic" /></feMerge></filter>
          <linearGradient id="bodyGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#163820" /><stop offset="100%" stopColor="#081408" /></linearGradient>
          <linearGradient id="headGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#1a4228" /><stop offset="100%" stopColor="#0a1c0c" /></linearGradient>
          <linearGradient id="eyeGrad" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stopColor={lime} stopOpacity="0.05" /><stop offset="50%" stopColor={lime} stopOpacity="1" /><stop offset="100%" stopColor={lime} stopOpacity="0.05" /></linearGradient>
          <linearGradient id="armGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#163220" /><stop offset="100%" stopColor="#060e07" /></linearGradient>
          <radialGradient id="coreRadial" cx="50%" cy="50%" r="50%"><stop offset="0%" stopColor={lime} stopOpacity="1" /><stop offset="50%" stopColor={lime} stopOpacity="0.6" /><stop offset="100%" stopColor={lime} stopOpacity="0" /></radialGradient>
          <radialGradient id="bgGlow" cx="50%" cy="40%" r="50%"><stop offset="0%" stopColor={lime} stopOpacity="0.07" /><stop offset="100%" stopColor={lime} stopOpacity="0" /></radialGradient>
          <clipPath id="eye-clip"><rect x="108" y="68" width="84" height="22" rx="4" /></clipPath>
        </defs>

        <ellipse cx="150" cy="280" rx="130" ry="200" fill="url(#bgGlow)" />
        <g id="orbit-1" opacity="0.22"><ellipse className="orbit-ring" cx="150" cy="210" rx="72" ry="30" fill="none" stroke={lime} strokeWidth="0.7" strokeDasharray="4 7" /></g>
        <g id="orbit-2" opacity="0.1"><ellipse className="orbit-ring" cx="150" cy="210" rx="98" ry="40" fill="none" stroke={lime} strokeWidth="0.5" strokeDasharray="3 9" /></g>
        ...
        <g id="robot-body-group">
          ...
          {[[90,155],[207,155],[90,362],[207,362]].map(([x,y],i) => <circle key={i} cx={x} cy={y} r="3.5" fill={dark} stroke={lime} strokeWidth="0.8" strokeOpacity="0.5" />)}
          ...
          <g id="robot-arm-left">
            ...
            {[63,72,81,90].map((x,i) => <rect key={i} x={x} y="314" width="7" height="14" rx="3.5" fill="url(#armGrad)" stroke={lime} strokeWidth="0.5" strokeOpacity="0.35" />)}
          ...
          <g id="robot-arm-right">
            ...
            {[207,216,225,234].map((x,i) => <rect key={i} x={x} y="314" width="7" height="14" rx="3.5" fill="url(#armGrad)" stroke={lime} strokeWidth="0.5" strokeOpacity="0.35" />)}
          ...
          <g id="robot-head">
            ...
            {[73,78,83].map(y => <line key={y} x1="108" y1={y} x2="192" y2={y} stroke={lime} strokeWidth="0.3" opacity="0.18" />)}
            ...
            {[125,133,141,149,157,165,173].map(x => <rect key={x} x={x} y="118" width="4" height="9" rx="1.5" fill={lime} opacity="0.22" />)}
        ...
        <g transform="translate(14, 158)" opacity="0.78">
          ...
          <line x1="0" y1="0" x2="10" y2="0" stroke={lime} strokeWidth="1.2" /><line x1="0" y1="0" x2="0" y2="10" stroke={lime} strokeWidth="1.2" />
          <line x1="58" y1="64" x2="48" y2="64" stroke={lime} strokeWidth="1.2" /><line x1="58" y1="64" x2="58" y2="54" stroke={lime} strokeWidth="1.2" />
        ...
        <g transform="translate(228, 258)" opacity="0.78">
          <rect x="0" y="0" width="58" height="64" rx="7" fill={dark} stroke={lime} strokeWidth="0.6" strokeOpacity="0.42" />
          <line x1="58" y1="0" x2="48" y2="0" stroke={lime} strokeWidth="1.2" /><line x1="58" y1="0" x2="58" y2="10" stroke={lime} strokeWidth="1.2" />
          <line x1="0" y1="64" x2="10" y2="64" stroke={lime} strokeWidth="1.2" /><line x1="0" y1="64" x2="0" y2="54" stroke={lime} strokeWidth="1.2" />
        ...
        <g transform="translate(198, 28)" opacity="0.72">
          ...
          <line x1="0" y1="0" x2="10" y2="0" stroke={lime} strokeWidth="1" /><line x1="0" y1="0" x2="0" y2="9" stroke={lime} strokeWidth="1" />
        ...
        <g transform="translate(14, 382)" opacity="0.72">
          <rect x="0" y="0" width="66" height="34" rx="6" fill={dark} stroke={lime} strokeWidth="0.6" strokeOpacity="0.45" />
          <line x1="66" y1="34" x2="56" y2="34" stroke={lime} strokeWidth="1" /><line x1="66" y1="34" x2="66" y2="25" stroke={lime} strokeWidth="1" />
        ...
        {[{cx:55,cy:148,cls:'fp-dot-1',r:2.5},{cx:246,cy:168,cls:'fp-dot-2',r:2},{cx:38,cy:305,cls:'fp-dot-3',r:2},{cx:262,cy:352,cls:'fp-dot-4',r:2.5},{cx:76,cy:422,cls:'fp-dot-5',r:2},{cx:224,cy:442,cls:'fp-dot-6',r:2}].map(({cx,cy,r,cls})=>(
          <circle key={cls} className={`data-dot ${cls}`} cx={cx} cy={cy} r={r} fill={lime} opacity="0.6" filter="url(#glow-soft)" />
        ))}
      </svg>
    </div>
  );
