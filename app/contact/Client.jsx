            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1.4fr',gap:'clamp(40px,6vw,96px)',alignItems:'start'}} className="c-grid">
              ...
              <div className="c-left">
                ...
                <div style={{display:'flex',flexDirection:'column',gap:'20px',marginBottom:'44px'}}>
                  {[{Icon:IconGlobe,label:'Website',val:'www.serveleadglobal.net'},{Icon:IconMail,label:'Email',val:'serveleadglobal@gmail.com'},{Icon:IconMapPin,label:'Location',val:'ServeLead Global Headquarters\nPlot 265/266 Beside KingFem Plaza, Mabushi, Abuja'},{Icon:IconClock,label:'Hours',val:'Mon–Fri: 8AM – 6PM WAT'}].map(({Icon,label,val})=>(
