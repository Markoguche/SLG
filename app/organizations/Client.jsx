...
const orgs=[
  ...
  {id:'shi',nm:'Servelead Humanitarian',tag:'Enhancing Educational Outcomes & Managing Development Funds',cat:'Nonprofit',col:'#B87EFF',logo:'comp5.png',ini:'SHI',web:'serveleadglobal.net/humanitarian',about:'A nonprofit dedicated to improving the socioeconomic status of African communities by enhancing educational outcomes and ensuring development funds deliver measurable impact.',svcs:['The BWB Initiative','NAAS – Nonprofit as a Service','Development Fund Management','Rural Education Programs'],stats:[{n:'$700K+',l:'Projects Executed'},{n:'50,000+',l:'Individuals Reached'},{n:'500+',l:'Youth Trained'},{n:'45%+',l:'Literacy Boost'}]},
];
